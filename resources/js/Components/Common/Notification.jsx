...
export default function Notification({ notifications, setNotifications }) {
    ...
    const renderNotificationItem = (n, isMobile = false) => {
            ...
            >
                <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        >
                            {n.data?.message || n.data?.body || "Notificación"}
                        </p>
                        <p
                            className={`${
                                isMobile ? "" : "mt-1"
            ...
            {showNotifications && (
                <>
                    ...
                    <div className="fixed inset-0 z-50 bg-white dark:bg-gray-900 md:hidden">
                        {/* Header móvil */}
                        <div className="flex items-center justify-between px-4 py-4 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <button
                                    className="flex items-center justify-center w-8 h-8 transition-colors duration-200 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700"
                        ...
                        <div className="flex-1 overflow-y-auto h-[calc(100vh-80px)]">
                            {notifications.length === 0 ? (
                                <div className="flex flex-col items-center justify-center h-full px-6 py-12 text-center">
                                    ...
                                    <p className="text-xs text-gray-600 dark:text-gray-400">
                                        Cuando tengas notificaciones aparecerán
                                        aquí
                                    </p>
                                </div>
                            ) : (
                    ...
                    {/* Vista desktop - Dropdown original */}
                    <div className="absolute right-0 sm:right-0 z-50 mt-4 w-80 max-w-[calc(100vw-1rem)] sm:max-w-sm overflow-hidden transition-all duration-300 border border-gray-200 dark:border-gray-700 shadow-2xl rounded-lg bg-white dark:bg-gray-900 transform -translate-x-4 sm:translate-x-0 hidden md:block">
